...
-   **报名方式：**点此填表（链接待定中……）并按表中要求加入比赛群
<!--[点此填表](http://buptra-tournaments.mikecrm.com/zcnj8cq)-->

-   **报名条件：**北邮及其他大学在读学生或已毕业校友

-   **直播链接：**待定

-   **实时对阵表：**待定中……<!--<https://challonge.com/zh_CN/yufeng2021yr>-->

### 赛制

选手需以学校为单位组队，每队三名选手。比赛分为单循环赛和单败淘汰赛两个阶段（暂定，视参赛队伍数量可能会做调整）。

下文详述赛制将使用到“场”、“盘”、“局”的概念，请注意区分。每场比赛指两队在某个比赛阶段中的一次遭遇，因为是组队竞技，所以每场包含多盘比赛，每盘比赛可能是1 V 1或者2 V 2，其又包含多局比赛。局是最小的单位。

每场比赛五盘三胜，第一盘为2V2，后面四盘都是1V1。每队每名选手出场两盘，出场顺序赛前确定不得更改。注意，一场比赛可能打不满五盘，比如其中一队连续赢得前三盘，这种情况下每名选手出场两盘的规则不适用。

每盘比赛选手不变，五局三胜（暂定，视参赛队伍数量可能会做调整），每局地图不同。

#### 循环赛阶段

将三或四队分为一小组，小组内进行单循环赛（若参赛队伍数量过少，可省去分组，所有队伍一起单循环）。每**场**比赛胜者积1分，负者积0分，若平局则双方各积0.5分。所有小组赛结束后，按积分高低排名，每组内前一或两名（暂定，视参赛队伍数量可能会做调整）出线。
...
-   **位置：**1 V 1随机；2 V 2根据地图决定，先选图的队伍后选位置。
...
本次比赛的报名条件为**北邮及其他大学在读学生或已毕业校友**，**唯一**的报名方式是**点此填表（链接待定中……）
<!--[点此填表](http://buptra-tournaments.mikecrm.com/zcnj8cq)-->
并按表中要求加入比赛群**，报名入口于**比赛开始前48小时**关闭。
